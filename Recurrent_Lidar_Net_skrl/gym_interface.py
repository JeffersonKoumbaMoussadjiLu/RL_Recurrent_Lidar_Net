...
class F110EnvWrapper(gym.Env):
    def __init__(self, config, seed=0):
        ...
        self.env = gym.make(env_id, seed=seed, map=map_path, params=params, model='dynamic_ST', enable_rendering=True, enable_scan=True, render_mode="unlimited", num_agents=1)
    ...
    def step(self, action):
        ...
        progress_reward = 1.0  # TODO: (optional track progress if available)
